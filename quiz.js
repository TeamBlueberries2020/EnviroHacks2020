...
//  shower, bath, toilet, machine dishes, hand dishes, machine laundry, hand laundry, lawn, car gasoline, car wash, electricity, shop, food
   ...
   dishesString = (Math.round(gallonsArray[3] + gallonsArray[4]) > 1) ? "The average person uses 6 gallons per cycle for every cycle with a dishwasher, and 8 gallons per cycle per cycle for handwashing dishes. Consider switching to a energy-star rated dishwasher, and it will save you on average 2 gallons of water every cycle. Also, only run the dishwasher when it is full.": "";
   ...
   shoppingString = (gallonsArray[11] > (583 * household)) ? "Lots of water is dealt with in the background when you go shopping. There are a lot of factors that use water, like the transportation of your goods and for the manufacturers to produce your goods. (for example, it takes over 1,230 gallons of water to make a single pound of cotton!) If you are starting to feel self-concious about your water usage while shopping, recycling and reusing your old goods helps to save water. ": "";
   foodString = (gallonsArray[12] > (1000 * household)) ? "As tasty as meat is, meat uses a ton of water because you need water for both the animals and their food. Try cutting back on meat in your diet by going a day without meat and/or eating meat alteratives.": ""; 
